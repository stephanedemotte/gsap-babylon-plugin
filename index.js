      ...
      for(var property in values) {
        ...
        switch (property) {
          case 'alpha':
            ...
            this._addTween(target.material, "alpha", target.material.alpha, value, property)
            break
          case 'color':
            let matColor = target.material.emissiveColor
          ...
          case 'z':
            ...
            break
          case 'scale':
            this._addTween(target.scaling, "x", target.scaling.x, value, "scaleX")
            this._addTween(target.scaling, "y", target.scaling.y, value, "scaleY")
            this._addTween(target.scaling, "z", target.scaling.z, value, "scaleZ")
            this._overwriteProps.push("scaleX", "scaleY", "scaleZ")
            break
          case 'scaleX':
            this._addTween(target.scaling, "x", target.scaling.x, value, property)
            break
          case 'scaleY':
            this._addTween(target.scaling, "y", target.scaling.y, value, property)
            break
          case 'scaleZ':
            this._addTween(target.scaling, "z", target.scaling.z, value, property)
            break
          case 'rotation':
          ...
          case 'rotationZ':
            ...
            break
          default:
            console.warn('Property "' + property + '" is not supported by the Babylon Plugin')
        }
